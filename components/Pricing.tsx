...
export default function Pricing() {
  ...
  const changePlan = (plan: string) => () => {
    if (plan === "monthly") {
      ...
      document.getElementById("monthly-btn")?.classList.remove("text-zinc-300");
      document.getElementById("annually-btn")?.classList.add("text-zinc-300");
      document.getElementById("annually-btn")?.classList.remove("text-white");
    } else {
      setIsMonthly(false);
      document.getElementById("monthly-btn")?.classList.add("text-zinc-300");
      document.getElementById("monthly-btn")?.classList.remove("text-white");
      document.getElementById("annually-btn")?.classList.add("text-white");
      document
    ...
    <section id="pricing" className="text-white">
      <div className="mx-auto max-w-7xl px-5 py-16 md:px-10 md:py-24">
        <div className="mx-auto mb-8 max-w-3xl text-center md:mb-12">
          <h2 className="text-3xl font-bold md:text-5xl">Available Plans</h2>
          <p className="mx-auto mt-4 max-w-xl text-sm text-zinc-300 md:text-base">
            Choose from our dynamic pricing plans, crafted to fit individuals of
            different listening behaviours and preferences. Get started with
            TailoredTales today!
          </p>
        </div>
        ...
        <div className="border md:w-max w-5/6 m-auto rounded-2xl py-1 px-4 text-slate-400 text-sm mb-5 transition duration-300 ease-in-out">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 md:gap-4">
          <div className="mx-auto max-w-md items-start rounded-md border-2 border-[#cdcdcd] p-8">
            ...
            <p className="mb-6 text-sm font-light text-zinc-300 sm:text-base md:mb-10">
              Start your journey with TailoredTales Free Plan. Enjoy up to 8
              hours of personalized podcast listening every month, perfect for
              casual learners and explorers. Dive into a world of knowledge
              today, absolutely free.
            </p>
            <h2 className="mb-5 text-3xl font-bold md:mb-6 md:text-5xl">
              {isMonthly ? pricing.monthly.free : pricing.annually.free}
            ...
            <div className="mt-2 flex flex-row items-center">
              ...
              <p className="text-sm sm:text-base">Higher waiting time</p>
            </div>
            <div className="mt-2 flex flex-row items-center">
              <div className="mr-2 flex w-4 flex-row items-center">
                <Image
          ...
          <div className="mx-auto max-w-md items-start rounded-md border-2 border-[#cdcdcd] p-8">
            ...
            <p className="mb-6 text-sm font-light text-zinc-300 sm:text-base md:mb-10">
              Take your curiosity further with TailoredTales Pro Plan. Gain
              access to 50 hours of podcast listening per month, ensuring you
              never run out of stories and explore any topic that piques your
              interest.
            </p>
            <h2 className="mb-5 text-3xl font-bold md:mb-6 md:text-5xl">
              {isMonthly ? pricing.monthly.pro : pricing.annually.pro}
              <span className="text-sm font-light sm:text-sm">
                {isMonthly ? "/month" : "/year"}
              </span>
            </h2>
            ...
            <div className="mt-2 flex flex-row items-center">
              ...
              <p className="text-sm sm:text-base">Access to all AI voices</p>
            </div>
            <div className="mt-2 flex flex-row">
              ...
              <p className="text-sm sm:text-base">No waiting time</p>
            </div>
            <div className="mt-2 flex flex-row">
              <div className="mr-2 flex w-4">
                <Image
            ...
            <div className="mt-2 flex flex-row">
              ...
              <p className="text-sm sm:text-base">Offline Listening</p>
            </div>
            <div className="mt-2 flex flex-row">
              <div className="mr-2 flex w-4">
                <Image
              ...
              <p className="text-sm sm:text-base">Fast Customer Support</p>
            </div>
          </div>
          <div className="mx-auto max-w-md items-start rounded-md border-2 border-[#cdcdcd] p-8">
            <div className="mb-4 w-fit rounded-[5px] bg-black px-4 py-1.5">
              <p className="text-sm font-bold text-white">ULTIMATE</p>
            </div>
            <p className="mb-6 text-sm font-light text-zinc-300 sm:text-base md:mb-10">
              Unleash the full potential of your learning with TailoredTales
              Ultimate Plan. With unlimited listening hours, your exploration
              knows no bounds. Elevate your podcast experience to the ultimate
              level!
            </p>
            <h2 className="mb-5 text-3xl font-bold md:mb-6 md:text-5xl">
              {isMonthly ? pricing.monthly.ultimate : pricing.annually.ultimate}
              <span className="text-sm font-light sm:text-sm">
                {isMonthly ? "/month" : "/year"}
              </span>
            </h2>
